...
def gdax_orderbooks(products,ilevel = 1):
    ...
    obk = {} 
    for product in products:        
#        pc.productID = product # for linux version 
#        obk = pc.getProductOrderBook(product)
...
def gdax_trades(products): # 100 most recent trades
    trades = []
    for product in products:
        print ('trades for product {} '.format(product))
        trade = {} 
...
if __name__ == '__main__':
    market_focus = 'ETH'
    products = gdax_focus(market_focus)
